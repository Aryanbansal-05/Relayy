...
const ThreadSection = () => {
  return (
    <section className="relative w-full py-40 px-4 overflow-hidden section-transition clip-path-swoop bg-animated-gradient">
      <div className="absolute inset-0 bg-gradient-to-tr from-emerald-100/30 via-emerald-200/20 to-emerald-300/10 opacity-70"></div>
      <div
        className="absolute -bottom-60 -left-60 w-[500px] h-[500px] bg-white/20 organic-shape animate-float"
        style={{ animationDelay: '-2s', animationDuration: '15s' }}
      ></div>
      <div
        className="absolute -top-60 -right-60 w-[500px] h-[500px] bg-white/20 organic-shape animate-float"
      ...
      <div className="relative max-w-6xl mx-auto flex flex-col items-center text-center">
        ...
        <div className="mt-24 w-full h-[600px] relative">
          <svg
          ...
          <div
            className="absolute top-[50%] left-[10%] w-32 h-32 -translate-y-1/2 animate-float"
            style={{ animationDuration: '8s' }}
          >
            <div className="relative w-full h-full">
              <div className="absolute inset-0 rounded-full bg-white/80 backdrop-blur-md shadow-2xl shadow-emerald-400/60 border-2 border-white"></div>
          ...
          <div
            className="absolute top-[20%] left-[45%] w-32 h-32 -translate-y-1/2 animate-float"
          ...
          <div
            className="absolute top-[80%] left-[30%] w-32 h-32 -translate-y-1/2 animate-float"
          ...
          <div
            className="absolute top-[10%] left-[80%] w-32 h-32 -translate-y-1/2 animate-float"
          ...
          <div
            className="absolute top-[65%] left-[75%] w-32 h-32 -translate-y-1/2 animate-float"
