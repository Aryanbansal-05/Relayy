...
const ThreadSection = () => {
  return (
    // --- STEP 1: Replaced 'bg-animated-gradient' with a static, non-laggy gradient ---
    <section className="relative w-full py-40 px-4 overflow-hidden section-transition clip-path-swoop bg-gradient-to-br from-emerald-100 to-emerald-300">
        ...
        <div className="mt-24 w-full h-[600px] relative">
          ...
          >
            <div className="relative w-full h-full">
              {/* --- STEP 3: Replaced 'bg-white/80 backdrop-blur-md' with 'bg-white/90' --- */}
